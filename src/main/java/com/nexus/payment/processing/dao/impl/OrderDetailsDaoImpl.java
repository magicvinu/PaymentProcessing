...
public class OrderDetailsDaoImpl extends JdbcDaoSupport implements OrderDetailsDao {
  ...
  public List<OrderDetails> getOrderDetailsFor(Long clientId) {
    String orderDetailQuery =
        "SELECT CLIENT.CLIENT_ID, PAYMENT_RECORD.PAYMENT_RECORD_ID,ORDERS.ORDER_ID, CLIENT.CLIENT_NAME, TOTAL_AMOUNT, PAYMENT_RECORD.STATUS AS PAYMENT_RECORD_STATUS, PROCESS_DATETIME FROM PAYMENT_RECORD \n"
