...
/**
 * The advice handles error condition and returns response. This helps in achieving separation of
 * concern. Service class should only focus on the business logic and leave the non business logic
 * to AOP's classes. Also for logging we could ues @Aspect
 */
@ControllerAdvice
public class PaymentProcessControllerAdvice extends ResponseEntityExceptionHandler {
  ...
  public ResponseEntity<Object> handleClientNotFoundException(
    ...
    return new ResponseEntity<>(
        notifications, ErrorMapperUtil.getHttpStatus(ex.getErrorMetaData()));
  }
